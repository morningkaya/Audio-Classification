...
def check_data() :
  if os.path.isfile(config.p_path):
    print('Loading data from {} model'.format(config.mode))
...
checkpoint = ModelCheckpoint(config.model_path, monitor='val acc', verbose = 1, mode='max', save_best_only=True, save_weights_only= False, period=1)
